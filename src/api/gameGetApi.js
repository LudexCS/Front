...
export const fetchGameList = async ({ page, limit }) => {
  try {
    const response = await axios.get("http://api.uosludex.com/management/api/get/list", {
      params: { page, limit },
    });
...
export const fetchOriginGameList = async ({ gameId }) => {
  try {
    const response = await axios.get("http://api.uosludex.com/management/api/get/origin", {
      params: { gameId },
    });
...
export const fetchVariantGameList = async ({ gameId }) => {
  try {
    const response = await axios.get("http://api.uosludex.com/management/api/get/variant", {
      params: { gameId },
    });
...
//   try {
//     const response = await axios.post("http://api.uosludex.com/management/api/get/byTags", {
//       tags,
//     });
...
export const fetchGamesByKeyword = async (keyword) => {
  try {
    const response = await axios.post("http://api.uosludex.com/management/api/get/search", {
      keyword,
    });
...
export const fetchGameDetail = async ({ gameId }) => {
  try {
    const response = await axios.get("http://api.uosludex.com/management/api/get/gameDetail", {
      params: { gameId },
    });
...
export const fetchGameResource = async ({ gameId }) => {
  try {
    const response = await axios.get("http://api.uosludex.com/management/api/get/resourceDetail", {
      params: { gameId },
    });
